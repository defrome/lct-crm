  ...
  return (
    <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_minmax(22rem,.8fr)]">
      <section className="card card-pad">
        ...
        />
        <ol className="mt-5 grid gap-4 text-body-s text-fg-soft">
          <li><strong className="text-fg">1. Выберите тип данных и файл.</strong> Нажмите «Новый импорт», выберите тип данных, затем загрузите файл .xlsx, .xls или .json размером до 20 МБ.</li>
