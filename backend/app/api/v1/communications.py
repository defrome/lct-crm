...
@router.post(
    ...
    description=(
        "Создаёт сообщение для указанного взаимодействия и прикрепляет к нему загруженные файлы."
    ),
)
...
@router.get(
    ...
    description=(
        "Возвращает содержимое вложения, доступного пользователю в рамках его области видимости."
    ),
)
